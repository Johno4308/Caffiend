...
const Contact = () => {
  return (
    <div className="contact-textzone">
      ...
      <p>
        Whether its a compliment, a critque or you burnt your hand touching that
        espresso while using this site
      </p>
      <p>
        Or maybe you are looking for a Junior Web Developer, whatever the case,
        i'm all ears.
      </p>
      ...
      <div className="contact-icons">
        ...
        <a target="_blank" rel="noreferrer" href="https://github.com/Johno4308">
